...
| PH8 Windows 对齐 | 基础精选体验与 PHOTO-02 查看器已实现并通过 Windows CI | 已完成个人/共享空间、文件夹浏览、公开 List v2 有界时间线、本地搜索/筛选、缩略图、保存副本、PHOTO-03A 单项导入、受限回收站恢复，以及图片/视频右侧预览、前后切换、基础文件元数据、键盘/双击打开和保存副本；提交 `4e1272e` 已通过 Windows xUnit、WinUI x64/ARM64 和 Repository Check。更完整 EXIF 白名单、沉浸式显示、高级照片管理及真实 Windows/NAS 验收继续后置 |
