...
| PH8 Windows 对齐 | 基础精选体验已实现 | 已完成个人/共享空间、文件夹浏览、公开 List v2 有界时间线、本地搜索/筛选、缩略图、保存副本、PHOTO-03A 单项导入和受限回收站恢复；继续补查看器/元数据等剩余语义及真实 Windows/NAS 验收 |
