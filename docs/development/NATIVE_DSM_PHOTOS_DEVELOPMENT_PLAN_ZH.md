...
> 最后更新：2026-08-10
> 当前状态：PH0 进行中；macOS PH1–PH3 基础能力已实现；Apple 移动 PH6-A 与 Windows PH8 已完成文件夹/时间线/缩略图/主动导入等精选主流程，仍待各自剩余语义与真实设备/NAS 验收；PH6-B 自动备份保持后续
> 首个参考平台：macOS
