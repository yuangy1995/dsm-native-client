...
public sealed partial class DsmRepository(
    ...
    DsmSession session,
    IDsmApiClient api,
    IReadOnlyDictionary<string, ApiCapability> capabilities) : IDsmRepository, IFileMutationRepository, IFileCopyMoveRepository, IFileRecycleRepository, IFilePreviewRepository, IFileShareLinkRepository, IFileLocationsRepository, IPhotoRepository, IChatRepository, IDownloadStationRepository, IVirtualMachineManagerRepository, IContainerManagerRepository, INasDetailsRepository
{
